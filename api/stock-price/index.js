...
async function fetchKrPrice(symbol, signal) {
...
async function fetchUsPrice(symbol, signal) {
...
async function fetchUsdKrw(signal) {
    try {
...
async function stockPriceHandler(context, req) {
    const q = req.query;
